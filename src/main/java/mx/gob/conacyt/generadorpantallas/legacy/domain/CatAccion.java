...
//        return "CatAccion [idAccion=" + idAccion + ", confirmacion=" + confirmacion + ", cssClass=" + cssClass
//                + ", cveAccion=" + cveAccion + ", descAccion=" + descAccion + ", fechaAlta=" + fechaAlta
//                + ", fechaModificacion=" + fechaModificacion + ", iconClass=" + iconClass + ", indEstatus=" + indEstatus
//                + ", indSeguridad=" + indSeguridad + ", usuarioAlta=" + usuarioAlta + ", usuarioModificacion="
//                + usuarioModificacion + ", widgetAccions=" + widgetAccions + "]";
//    }
